...
export function useActiveSection(
  ...
  useEffect(() => {
    ...
    const updateActive = () => {
      ...
      // At the bottom of the guide, highlight the final section even if its heading
      // cannot reach the reading line (short pages / last items in a long list).
      ...
      // Sections are in document order (parents before children). The last section
      // whose heading has passed the reading line is the most specific match.
