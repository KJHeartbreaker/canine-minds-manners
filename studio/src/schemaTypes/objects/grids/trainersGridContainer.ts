...
export const trainersGridContainer = defineType({
  ...
  preview: {
    select: {
      ...
      trainerImage: 'trainers.0.picture',
    },
    prepare: ({trainer0, trainer1, trainer2, trainer3, trainerImage}) => {
